...
const ProductDetails = () => {
  ...
  // Mock multiple images for the gallery effect, using the single product image
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="w-full lg:w-3/5 flex flex-col-reverse lg:flex-row gap-4">
            ...
            <div className="flex lg:flex-col gap-4 overflow-x-auto lg:overflow-visible lg:w-24 flex-shrink-0">
              {images.map((img, index) => (
                <div
                  key={index}
                  className={`w-20 h-20 lg:w-24 lg:h-24 cursor-pointer border-2 transition-all duration-300 ${
          ...
          <div className="w-full lg:w-2/5 flex flex-col justify-center">
            ...
            <div className="prose text-gray-600 leading-relaxed mb-8 font-light text-sm">
              ...
              <p className="mt-4">
                Handcrafted with precision and care, this piece embodies the spirit of modern luxury.
                Ideally suited for special occasions or adding a touch of elegance to your everyday attire.
              </p>
            </div>
